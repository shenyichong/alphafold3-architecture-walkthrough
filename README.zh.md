...
- [🏗️ 输入准备](#️-输入准备)
  - [MSA和Templates](#msa和templates)
    - [为什么需要MSA？](#为什么需要msa)
    - [为什么需要Templates？](#为什么需要templates)
    - [如何获取MSA？](#如何获取msa)
    - [如何获取Templates？](#如何获取templates)
    - [如何表征Templates？](#如何表征templates)
  - [原子级表征](#原子级表征)
    - [构建p和q](#构建p和q)
    - [更新q（Atom Transformer）](#更新qatom-transformer)
  - [Token级表征](#token级表征)
    - [Token级单序列表征](#token级单序列表征)
    - [Token级对表征](#token级对表征)
- [🧠 表征学习](#-表征学习)
  - [Template模块](#template模块)
  - [MSA模块](#msa模块)
  - [Pairformer模块](#pairformer模块)
- [🔮 结构预测](#-结构预测)
  - [扩散模型基础概念](#扩散模型基础概念)
  - [详细结构预测](#详细结构预测)
    - [采样扩散（推理过程）](#采样扩散推理过程)
